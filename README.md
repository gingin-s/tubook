...
# アプリケーション概要
youtube動画に動画の時間を指定したコメントを追加し、自分だけのBookを作れます。  
また、Room機能では特定のメンバーとBookを共有でき、リアルタイムチャットでメンバーとのコミュニケーションが簡単に取れます。
...
<img width="1440" alt="チャット画面" src="https://user-images.githubusercontent.com/98451976/160085768-28b7164e-2a1f-482a-a280-5492363a0e45.png">
